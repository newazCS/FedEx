...
public class ReusableActions {
    ...
    public static void Submit(WebDriver driver, WebElement xpathLocator,ExtentTest logger){
        // define by explicit wait
        WebDriverWait wait = new WebDriverWait(driver,10);
    ...
    public static void dropdownByText(WebDriver driver,WebElement xpath,String userValue,String elementName){
        WebDriverWait wait = new WebDriverWait(driver,10);
        try{
    ...
    public static void hoverAction(WebDriver driver,WebElement xpath,String elementName){
        WebDriverWait wait = new WebDriverWait(driver,10);
    ...
    public static void clickMultiElement(WebDriver driver,WebElement xpath,int index,String elementName){
        WebDriverWait wait = new WebDriverWait(driver,10);
